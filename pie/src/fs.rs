...
mod test {
  ...
  #[test]
  fn test_metadata_ok() -> Result<(), Box<dyn Error>> {
  ...
  #[test]
  fn test_metadata_none() -> Result<(), Box<dyn Error>> {
    let temp_file = create_temp_file()?;
  ...
  #[test]
  fn test_open_if_file() -> Result<(), Box<dyn Error>> {
    let temp_file = create_temp_file()?;
  ...
  #[test]
  fn test_open_if_file_non_existent() -> Result<(), Box<dyn Error>> {
    let temp_file = create_temp_file()?;
    remove_file(&temp_file)?;
    let file = open_if_file(&temp_file)?;
    assert!(file.is_none());
  ...
  #[test]
  fn test_open_if_file_on_directory() -> Result<(), Box<dyn Error>> {
